...
int ll_map(LinkedList* this,int (*pFunc)(void*)); /// recorre ejecutando la función que recibe como parámetro
...
LinkedList* ll_filter(LinkedList* this,int (*pFunc)(void*)); /// crea una lista nueva con los elementos que cumplan el filtro de la funcion parámetro
